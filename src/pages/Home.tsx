...
const articles = [
  {
    ...
    description:
      "A practical structure for React applications that need to stay understandable as features, teams and business rules grow.",
    href: "/blog/react-enterprise"
  },
  {
    category: "Mobile",
    readTime: "7 min read",
    title: "Designing Reliable React Native Verification Flows",
    description:
      "Patterns for camera permissions, file handling, native modules and user feedback in verification-heavy mobile experiences."
  },
  {
    category: "Backend",
    readTime: "8 min read",
    title: "Secure REST APIs Beyond the Happy Path",
    description:
      "How validation, permissions, idempotency and careful error states make backend services safer to operate in production."
  }
];
        ...
        <main>
          ...
          <section className={styles.section} id="certifications">
            <motion.div className={styles.sectionIntro} {...reveal}>
              ...
              <p>
                A concise view of the certifications currently listed in my portfolio.
              </p>
            </motion.div>
          ...
          <section className={styles.section} id="work">
            <motion.div className={styles.sectionIntro} {...reveal}>
              ...
              <p>
                Filter the portfolio by the kind of product you want to explore.
              </p>
            </motion.div>
          ...
          <section className={styles.section} id="expertise">
            <motion.div className={styles.sectionIntro} {...reveal}>
              ...
              <p>
                Broad enough to own features end-to-end, focused enough to care about the details.
              </p>
            </motion.div>
          ...
          <section className={styles.section} id="articles">
            <motion.div className={styles.sectionIntro} {...reveal}>
              <span className={styles.sectionIndex}>06 / Articles</span>
              <h2>Notes from building, debugging and shipping.</h2>
              <p>
                Practical writing on frontend architecture, mobile workflows and backend reliability.
              </p>
            </motion.div>
          ...
          <section className={styles.contactSection} id="contact">
            <motion.div className={styles.contactCard} {...reveal}>
              <div className={styles.contactCopy}>
                <span className={styles.sectionIndex}>07 / Contact</span>
                <h2>Have a product, role or technical problem worth discussing?</h2>
                <p>
                  No contact form. Reach me directly by email or GitHub and I&apos;ll respond through the channel you choose.
                </p>
              </div>
              ...
              <div className={styles.contactLinks}>
                <a href="mailto:muhammadyaseen3294@gmail.com" className={styles.contactLink}>
                  ...
                  <span>
                    <small>Email</small>
                    <strong>muhammadyaseen3294@gmail.com</strong>
                  </span>
                  <FiArrowUpRight />
                </a>
                ...
                <div className={styles.contactLink}>
                  ...
                  <span>
                    ...
                    <strong>Pakistan · Remote-friendly</strong>
                  </span>
                  <FiBriefcase />
                </div>
              </div>
